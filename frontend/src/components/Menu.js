    ...
    <section className="text-gray-600 body-font" style={{ height: "150px" }}>
      <div className="container px-5 py-24 mx-auto flex flex-wrap flex-col">
        <div className="flex mx-auto flex-wrap mb-20">
          <a
            href="/step1"
            className="sm:px-6 py-3 w-1/2 sm:w-auto justify-center sm:justify-start border-b-2 title-font font-medium bg-gray-100 inline-flex items-center leading-none border-blue-500 text-blue-500 tracking-wider rounded-t"
          >
            <svg
              fill="none"
              stroke="currentColor"
